...
from core.reduction import MeanReduction
...
def get_arguments():
    epilog = "note: argument \'--scheduler\' accept different learning rate scheduling choices (\'exp\' or \'step\') followed by decaying factor and decaying period\n\n" \
        "examples:\n\n" \
        ">>> python3 experiments/centralized_baseline.py --batch_size 256 --lr 0.1 --momentum 0.9 --weight_decay 0.0001 --epochs 10 --scheduler exp 0.5\n\n" \
        ...
        ">>> python3 experiments/centralized_baseline.py --batch_size 512 --lr 0.01 --epochs 100 --scheduler step 0.75 3\n\n" \
        "This command executes the experiment using\n" \
        " [+] batch size: 512\n" \
        ...
        ">>> python3 experiments/centralized_baseline.py --batch_size 512 --lr 0.01 --epochs 100 --scheduler linear 0.1 8\n\n" \
        "This command executes the experiment using\n" \
        " [+] batch size: 512\n" \
        " [+] learning rate: 0.1 is starting factor of linear growth for 8 epochs\n" \
        " [+] running epoch for training and validation: 100\n\n" \
        ">>> python3 experiments/centralized_baseline.py --batch_size 512 --lr 0.01 --epochs 100 --scheduler onecycle 0.1\n\n" \
        "This command executes the experiment using\n" \
        " [+] batch size: 512\n" \
...
if __name__ == '__main__':
    ...
    identifier = f"emnist_s{args.seed}_e{args.epochs}_lr{args.lr}_lrs{':'.join(args.scheduler)}_bs{args.batch_size}_m{args.momentum}_wd{args.weight_decay}"
    # log
    wandb.init(
